...
#ifndef FRAMEX_COMMON_DEFINE_H
#define FRAMEX_COMMON_DEFINE_H

namespace framex {

#define DEF_APP_NAME "FrameX" // 系统英文名称
#define DEF_APP_NAME_CN "系 统 基 础 模 块" // 系统中文名称
#define DEF_APP_VERSION "V1.0.4 Build 20231210" // 系统版本号
#define DEF_APP_DEVELOPER "Developed by the X-Lab." // 开发者声明
#define DEF_APP_COMPANY "X-Lab (Shanghai) Co., Ltd." // 公司声明
#define DEF_APP_COPYRIGHT "Copyright 2017-2023 X-Lab All Rights Reserved." // 版权声明
...
#define NW_MSG_CODE_JSON                  NW_MSG_CODE_TYPE_MIN + 2 // Json 格式
#define NW_MSG_CODE_BASE64                NW_MSG_CODE_TYPE_MIN + 3 // Base64 格式
#define NW_MSG_CODE_PROTOBUF              NW_MSG_CODE_TYPE_MIN + 4 // ProtoBuf 格式
#define NW_MSG_CODE_ZLIB                  NW_MSG_CODE_TYPE_MIN + 5 // ZLib 格式
#define NW_MSG_CODE_MSGPACK               NW_MSG_CODE_TYPE_MIN + 6 // MsgPack 格式
#define NW_MSG_CODE_TYPE_MAX 15 // 网络通信 编码 类型终止

// 网络数据包功能定义
#define NW_MSG_FUNC_TYPE_MIN 0 // 网络通信 功能 类型起始
#define NW_MSG_FUNC_NONE                  NW_MSG_FUNC_TYPE_MIN + 0 // 无任何功能
#define NW_MSG_FUNC_TYPE_MAX 65535 // 网络通信 功能 类型终止

} // namespace framex

#endif // FRAMEX_COMMON_DEFINE_H
